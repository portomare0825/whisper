...
const sqlPath = 'supabase/database_size.sql';
let sql = '';
try {
...
console.log(`🚀 Ejecutando SQL de consulta de tamaño de base de datos...`);
...
async function run() {
  try {
    ...
    console.log('✅ Migración de tamaño de base de datos aplicada exitosamente en Supabase.');
  } catch (error) {
