...
const sqlPath = 'supabase/avatar_slots.sql';
let sql = '';
try {
...
console.log(`🚀 Ejecutando SQL de Ranuras de Avatares...`);
...
async function run() {
  try {
    ...
    console.log('✅ Migración de Ranuras de Avatares aplicada exitosamente en Supabase.');
  } catch (error) {
