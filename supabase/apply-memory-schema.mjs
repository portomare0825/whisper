...
const sqlPath = 'supabase/memory_and_persistence.sql';
let sql = '';
try {
...
console.log(`🚀 Ejecutando SQL de migración de memoria y persistencia...`);
...
async function run() {
  try {
    ...
    console.log('Detalles del resultado:', data);
  } catch (error) {
