...
export function PremiumPoseSelector({
  ...
  return (
    <div className="flex flex-col h-full max-h-[90vh] w-full max-w-2xl mx-auto animate-in fade-in zoom-in-95 duration-300 text-left relative">
      
      {/* Contenedor Scrollable para el catálogo y configuraciones */}
      <div className="flex-1 overflow-y-auto p-6 md:p-8 pt-10 md:pt-12 space-y-6 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      <div className="shrink-0 p-6 md:p-8 pt-4 border-t border-white/10 bg-black/40 backdrop-blur-md rounded-b-3xl">
        <div className="flex gap-3">
          ...
          >
            {isGenerating ? (
              <>
                <Loader2 className="w-5 h-5 animate-spin" /> Magia en progreso...
              </>
            ) : (
              <>
